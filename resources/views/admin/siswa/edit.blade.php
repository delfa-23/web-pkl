  ...
  <div class="container mx-auto p-6 max-w-lg">
    ...
    <div class="flex items-center justify-between mb-6">
      <h1 class="text-2xl font-semibold text-[#1d9a96]">
        <i class="fas fa-user-graduate"></i> Edit Data Siswa
      </h1>
      ...
      <form action="{{ route('admin.siswa.update', $siswa->id) }}" method="POST" class="space-y-4">
        ...
        <div>
          ...
          <input type="text" name="nama" value="{{ $siswa->nama }}" required
                 class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#1d9a96]">
        </div>
        ...
        <div>
          <label class="block font-medium">Password
        ...
        <div>
          ...
          <select name="kelas" id="kelas"
                  class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#1d9a96]" required>
        ...
        <div>
          ...
          <textarea name="alamat"
                    class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#1d9a96]">{{ $siswa->alamat }}</textarea>
        </div>
        ...
        <div>
          <label class="block font-medium">Status Siswa</label>
          <select name="status"
                  class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-[#1d9a96]" required>
