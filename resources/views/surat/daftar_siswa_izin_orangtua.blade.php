                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    <!-- Export Word -->
                                    <a href="{{ route('surat.word_izin', $siswa->id) }}" class="btn btn-sm text-white"
                                        style="background-color:#4b91c9;" title="Download Word">
                                        <i class="fa-solid fa-file-word me-1"></i> Download Word
                                    </a>
